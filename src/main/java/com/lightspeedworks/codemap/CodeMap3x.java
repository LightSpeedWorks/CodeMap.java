 ...
 */
public class CodeMap3x implements ICodeMap {
	// /**
	// * not found.
	// */
	 ...
	 * max index 0: zero.
	 */
	static final int MAX_INDEX_ZERO = 0x400;
	 ...
	 * max index 2: two.
	 */
	static final int MAX_INDEX_TWO = 0x800;
	 ...
	 * @return CodeMap
	 */
	public CodeMap3x set(final int index, final int value) {
